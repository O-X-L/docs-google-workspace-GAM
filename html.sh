...
do
  ...
  echo '----' >> "$file"
  echo '' >> "$file"
  echo "[Original Documentation on GitHub](https://github.com/GAM-team/GAM/wiki/${file_rel})" >> "$file"
done
echo '</urlset>' >> "$FILE_SM"
...
HTML_LOGO_LINK_EN='href="https://github.com/GAM-team/GAM" class="oxl-nav-logo" title="GAM Project"'
HTML_LANG_NONE='<html'
